...
<head>
  ...
  <link rel="stylesheet" href="/public/hub/css/leaflet.css">
  ...
  <link rel="stylesheet" href="/public/hub/css/custom.css">
</head>
<body style="background-color: #000000; padding-top:0px;">
  <main>  
    {{$slot}}
  </main>
  <script src="/public/hub/js/bootstrap-bundle.min.js"></script>
  <script src="/public/hub/js/custom.js"></script>
</body>
